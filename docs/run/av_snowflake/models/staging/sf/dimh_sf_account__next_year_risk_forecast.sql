  ...
  create or replace   view AV_EDM.AV_STAGING.dimh_sf_account__next_year_risk_forecast
...
select  created_date as effective_date_start
        ...
        ,new_value as next_year_risk_forecast_percent
from sf_acct_his
where field = 'next_year_risk_forecast'
  );
